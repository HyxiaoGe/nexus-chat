          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-white/90 text-sm">
                {t('welcome.subtitle', 'Multi-LLM Orchestrator')}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t(
                  ...
                  'Get responses from Claude, GPT-4, Gemini, and DeepSeek simultaneously.'
                )}
              </p>
            </div>
          </div>
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t(
                  ...
                  'Start chatting immediately with our free tier, or configure your own API key for unlimited access.'
                )}
              </p>
            </div>
          </div>
